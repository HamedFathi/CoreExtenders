    ...
    public class JsonClassGenerator : IJsonClassGeneratorConfig
    {
        ...
        public void GenerateClasses()
        {
            ...
            if (writeToDisk)
            {
                ...
                if (writeToDisk && !NoHelperClass && ExplicitDeserialization) File.WriteAllText(Path.Combine(TargetFolder, "JsonClassHelper.cs"), ClassContent.JsonClassHelper);
                if (SingleFile)
                {
        ...
        private string CreateUniqueClassNameFromPlural(string plural)
        {
            ...
            return CreateUniqueClassName(plural.Singularize(false));
        }
